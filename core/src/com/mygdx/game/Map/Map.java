...
public class Map {
    ...
    public void maze () {
        ...
        if (randomDirection <= 0.25) {
            ...
            for (int i = 0; i < 41; i++) {
                for (int j = 0; j < 41; j++) {
                    SML.get(startingY + j).set(startingX + i, mazeList.get(41-j).get(i));
                }
            }
        }
            ...
            for (int i = 0; i < 41; i++) {
                for (int j = 0; j < 41; j++) {
                    SML.get(startingY + j).set(startingX + i, mazeList.get(j).get(41-i));
                }
            }
        }
            ...
            for (int i = 0; i < 41; i++) {
                for (int j = 0; j < 41; j++) {
                    SML.get(startingY + j).set(startingX + i, mazeList.get(41-j).get(41-i));
                }
            }
        }
    }
